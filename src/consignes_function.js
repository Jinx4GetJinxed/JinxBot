...
export function Consignes1() {
    client.on('messageCreate', async (message) => {
        const consignes1 = new MessageEmbed()
            ...
            .setAuthor("Ce bot a été créé par Hakim Id Brahim", message.author.displayAvatarURL(), 'https://www.instagram.com/hakim_id_brahim/?')
        ...
        module.exports = (consignes1)
    })
}


export function Consignes2() {
    client.on('messageCreate', async (message) => {
